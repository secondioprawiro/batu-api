...
const STEPS = [
  {
    ...
    desc: "Connect your Celo wallet and enter the arena.",
  },
  {
    n: "02",
    title: "Deposit CELO",
    desc: "Start from 0.001 CELO — instantly converted to API Coin.",
  },
  {
    n: "03",
    title: "Choose Element",
    desc: "Choose Batu, Api, Air, or Daun, then place your API bet.",
  },
  {
    n: "04",
    title: "Win API Reward",
    desc: "Beat the opponent and take home rewards from the battle pool.",
  },
];
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        <Reveal>
          <p className="font-display text-center text-lg tracking-wide text-ember-300/90">
            Batu, Api, Air, and Daun clash in the on-chain arena ~ ♪
          </p>
          <div className="mt-6">
            <SectionHeading
              eyebrow="GAME FLOW"
              title="How to Enter the Arena"
              subtitle="Four simple steps from wallet to your first victory."
            />
          </div>
        </Reveal>
